...
def get_group_data():
    ...
    """
    url = ('https://graph.facebook.com/v2.3/%s/feed?fields=id,permalink_url,'
           'created_time,from,message,type,link,likes.limit(0).summary(true),'
...
def write_csv():
    ...
    """
    with open('%s_group.csv' % GID, 'w', encoding='utf-8') as file_name:
